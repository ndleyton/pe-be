...
class TestRecipeBusinessRules:
    ...
    def test_complex_workout_structure_validation(self):
        ...
        assert len(complex_workout.exercise_templates[1].set_templates) == 4  # Main lift
        assert len(complex_workout.exercise_templates[2].set_templates) == 3  # Accessory