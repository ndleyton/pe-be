...
class TestRecipeSchemas:
    """Test Recipe Pydantic schemas for validation and serialization."""
    ...
    def test_recipe_create_valid(self):
        """Test creating a valid RecipeCreate."""
    ...
    def test_recipe_create_missing_required_fields(self):
        """Test RecipeCreate with missing required fields."""
        with pytest.raises(ValidationError):
            RecipeCreate()  # Missing name and workout_type_id

    def test_recipe_update_partial(self):
        """Test RecipeUpdate allows partial updates."""
    ...
    def test_recipe_update_empty_name_invalid(self):
        """Test RecipeUpdate with invalid empty name."""
        with pytest.raises(ValidationError) as exc_info:
            RecipeUpdate(name="")
        assert "at least 1 character" in str(exc_info.value)
...
class TestRecipeBusinessLogic:
    """Test Recipe business logic and data transformations."""

    def test_recipe_creation_workflow(self):
        """Test complete recipe creation workflow."""
        # Simulate creating a recipe from workout data
        exercise_templates = [
            ExerciseTemplateCreate(
    ...
    def test_recipe_update_preserves_structure(self):
        """Test that recipe updates preserve existing structure."""
        original_recipe = RecipeCreate(
    ...
    def test_complex_workout_recipe(self):
        """Test a complex recipe with multiple exercises and varied set schemes."""
        complex_recipe = RecipeCreate(
...
class TestRecipeValidation:
    """Test Recipe schema validation edge cases and error handling."""
