...
class ExerciseTemplate(Base):
    ...
    recipe: Mapped["Recipe"] = relationship("Recipe", back_populates="exercise_templates")
...
class SetTemplate(Base):
    ...
    # Relationships
    intensity_unit: Mapped["IntensityUnit"] = relationship("IntensityUnit", lazy="joined")
    exercise_template: Mapped["ExerciseTemplate"] = relationship("ExerciseTemplate", back_populates="set_templates")