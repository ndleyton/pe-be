...
def upgrade() -> None:
    ...
    op.add_column('recipes', sa.Column('is_readonly', sa.Boolean(), server_default=sa.text('false'), nullable=False))
    ...
    op.create_index('ix_recipes_creator_visibility', 'recipes', ['creator_id', 'visibility'], unique=False)
