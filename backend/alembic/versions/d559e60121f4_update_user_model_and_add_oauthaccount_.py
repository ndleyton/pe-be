...
def downgrade() -> None:
    ...
    op.add_column(
        "users", sa.Column("uid", sa.VARCHAR(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "users",
        sa.Column(
    ...
    op.add_column(
        "users",
        sa.Column(
            "encrypted_password", sa.VARCHAR(), autoincrement=False, nullable=False
        ),
    )
    op.add_column(
        "users",
        sa.Column(
            "reset_password_token", sa.VARCHAR(), autoincrement=False, nullable=True
        ),
    )
    op.drop_index(op.f("ix_users_email"), table_name="users")
    op.create_unique_constraint(
        "users_reset_password_token_key", "users", ["reset_password_token"]
    )
