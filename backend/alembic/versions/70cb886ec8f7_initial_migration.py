...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    # Note: Removed creation of 'ar_internal_metadata' and 'schema_migrations'
    # These were legacy tables from a previous migration system that are not created in upgrade()
