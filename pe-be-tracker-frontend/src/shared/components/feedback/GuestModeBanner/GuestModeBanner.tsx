...
const GuestModeBanner: React.FC = () => {
  ...
  return (
    <div className="pointer-events-none">
      <div className="fixed top-16 left-0 right-0 lg:left-64 z-40 px-4">
        <div className="bg-accent border-l-4 border-primary p-4 rounded-md shadow pointer-events-auto">
          <div className="flex">
