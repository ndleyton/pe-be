...
export const ExerciseTypeCard = ({ exerciseType }: ExerciseTypeCardProps) => {
  ...
  return (
    ...
    >
      <div className="flex h-full flex-col overflow-hidden rounded-2xl border border-border/40 bg-card/60 p-6 backdrop-blur-md transition-all duration-300 hover:scale-[1.02] hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/5 active:scale-[0.98]">
        ...
        {description && (
          <p className="text-muted-foreground mb-6 line-clamp-2 text-sm font-medium leading-relaxed opacity-70 transition-opacity group-hover:opacity-100">
            {description}
          </p>
        )}
