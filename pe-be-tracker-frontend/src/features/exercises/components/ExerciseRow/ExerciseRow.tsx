...
const ExerciseRow = ({
  ...
  return (
    <Card key={exercise.id} className="bg-card/80 overflow-hidden rounded-2xl border border-border/10 shadow-lg backdrop-blur-sm shadow-black/5 hover:shadow-xl transition-all duration-300">
